...
# 5. Which F9 Booster version (v1.0, v1.1, FT, B4, B5, etc.) has the highest launch success rate? B5 (only one successful start), apart from that FT (15 successes, 8 failures)